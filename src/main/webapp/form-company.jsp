			...
			<div class="row">
				...
				<div class="form-group col-md-6">
					<label for="role">Cargo</label> <input type="text"
						...
						oninvalid="this.setCustomValidity('Por favor, informe o cargp.')"
						oninput="setCustomValidity('')" />
				</div>
			</div>
			<div class="row">
				<div class="form-group col-md-4">
					<label for="end">Data Início</label> <input type="date"
				...
				<div class="form-group col-md-4">
					<label for="role">Data Saída</label> <input type="date"
						class="form-control" id="role" name="role" autofocus="autofocus"
						placeholder="Cargo" required
						oninvalid="this.setCustomValidity('Por favor, informe o cargp.')"
						oninput="setCustomValidity('')" />
